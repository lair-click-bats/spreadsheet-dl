...
```bash
pip install spreadsheet-dl                    # Basic installation
pip install spreadsheet-dl[security]          # With security enhancements (recommended)
pip install spreadsheet-dl[all]               # All features and domains
```
