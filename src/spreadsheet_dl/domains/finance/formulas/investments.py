...
class ReturnOnInvestment(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({current_value}-{initial_value})/{initial_value}*100"
...
class CompoundAnnualGrowthRate(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"(POWER({ending_value}/{beginning_value};1/{years})-1)*100"
...
class CompoundInterest(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        # A = P(1 + r/n)^(nt)
        return (
            f"{principal}*POWER(1+{rate}/{compounds_per_year};"
...
class SharpeRatio(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({portfolio_return}-{risk_free_rate})/{std_deviation}"
