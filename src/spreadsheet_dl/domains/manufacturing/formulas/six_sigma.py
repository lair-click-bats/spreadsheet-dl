...
class DPMOFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({defects}/({units}*{opportunities}))*1000000"
...
class SigmaLevelFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"0.8406+SQRT(29.37-2.221*LN({dpmo}))"
...
class DefectRateFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({defects}/{total_units})*100"
...
class GaugeRnRFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"SQRT({repeatability}^2+{reproducibility}^2)"
