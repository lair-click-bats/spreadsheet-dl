...
class BullwhipEffectFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{order_variance}/{demand_variance}"
...
class NewsvendorModelFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({selling_price}-{cost})/({selling_price}-{salvage_value})"
...
class ABCAnalysisFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({item_value}/{total_value})*100"
...
class ServiceLevelFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({orders_fulfilled}/{total_orders})*100"
