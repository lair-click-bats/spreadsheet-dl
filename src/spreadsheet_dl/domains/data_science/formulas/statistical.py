...
class TTestFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"TTEST({array1};{array2};{tails};{type_arg})"
...
class ZTestFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        if sigma is not None:
            return f"ZTEST({array};{x};{sigma})"
        return f"ZTEST({array};{x})"
...
class ChiSquareTestFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"CHITEST({observed};{expected})"
