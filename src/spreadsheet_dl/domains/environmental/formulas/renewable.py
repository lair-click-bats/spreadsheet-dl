...
class SolarPanelOutputFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{irradiance}*{area}*{efficiency}"
...
class WindTurbinePowerFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"0.5*{air_density}*{area}*{velocity}^3*{power_coeff}"
...
class EnergyPaybackTimeFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{energy_input}/{annual_output}"
...
class CapacityFactorFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{actual_output}/({rated_capacity}*{time_period})"
...
class LevelizedCostEnergyFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({capex}+{opex_npv})/({energy_npv})"
...
class EnergyReturnInvestmentFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{energy_output}/{energy_input}"
...
class SolarPanelEfficiencyFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{power_output}/({irradiance}*{area})*100"
...
class WindCapacityFactorFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{actual_energy}/({rated_capacity}*{hours})*100"
...
class BatteryStorageCapacityFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({daily_demand}*{autonomy_days})/{depth_discharge}"
...
class GridStabilityIndexFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({renewable_capacity}+{storage_capacity})/{total_capacity}*100"
...
class CarbonIntensityFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{co2_emissions}/{energy_produced}*1000"
