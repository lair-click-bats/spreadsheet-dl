...
class RadiativeForcingFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"5.35*LN({co2_current}/{co2_reference})"
...
class ClimateSensitivityFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{radiative_forcing}/{climate_feedback}"
...
class IceSheetMeltingFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        if area and str(area) not in ("", "None"):
            ...
            return f"({accumulation}-{ablation})*{area}/1000"
        else:
            # Simple mass balance
            return f"{accumulation}-{ablation}"
...
class CarbonBudgetFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"({target}-{current})/{tcre}*1000"
