...
class GlobalWarmingPotential(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{co2_emissions}*1+{ch4_emissions}*25"
...
class AcidificationPotential(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        # AP = NOx*0.7 + SO2*1.88
        return f"{nox_emissions}*0.7+{so2_emissions}*1.88"
...
class EutrophicationPotential(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{nox_emissions}*0.42+{nh3_emissions}*0.13+{po4_emissions}*3.64"
