...
class HardyWeinbergFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{p_freq}^2 + 2*{p_freq}*{q_freq} + {q_freq}^2"
...
class LinkageDisequilibriumFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{freq_ab} - ({freq_a} * {freq_b})"
...
class RecombinationFrequencyFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{recombinants}/{total_offspring}"
...
class Chi2GeneticsFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"SUMPRODUCT(({observed_range} - {expected_range})^2 / {expected_range})"
...
class InbreedingCoefficientFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"1 - ({observed_heterozygosity}/{expected_heterozygosity})"
