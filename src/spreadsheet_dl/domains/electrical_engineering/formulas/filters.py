...
class LowPassCutoffFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"1/(2*PI()*{resistance}*{capacitance})"
...
class BandPassCenterFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"1/(2*PI()*SQRT({inductance}*{capacitance}))"
...
class QFactorFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{resonant_freq}/{bandwidth}"
...
class FilterAttenuationFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"-20*{order}*LOG10({frequency}/{cutoff_freq})"
