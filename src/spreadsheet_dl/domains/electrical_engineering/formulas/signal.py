...
Implements:
    TASK-C002: Signal formulas (SNR, BANDWIDTH, RISE_TIME, PROPAGATION_DELAY)
"""
...
class SignalToNoiseRatioFormula(BaseFormula):
    ...
    Implements:
        TASK-C002: SIGNAL_TO_NOISE_RATIO formula
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        Returns:
            ODF formula string: 10*LOG10(signal_power/noise_power)
        """
        self.validate_arguments(args)
        signal_power, noise_power = args
        return f"10*LOG10({signal_power}/{noise_power})"
...
class BandwidthFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        Returns:
            ODF formula string: 0.35/rise_time
        """
        self.validate_arguments(args)
        (rise_time,) = args
        return f"0.35/{rise_time}"
...
class RiseTimeFormula(BaseFormula):
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        Returns:
            ODF formula string: 2.2*resistance*capacitance
        """
        self.validate_arguments(args)
        capacitance, resistance = args
        return f"2.2*{resistance}*{capacitance}"
...
class PropagationDelayFormula(BaseFormula):
    ...
    Implements:
        TASK-C002: PROPAGATION_DELAY formula
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        Returns:
            ODF formula string: length/velocity
        """
        self.validate_arguments(args)
        length, velocity = args
        return f"{length}/{velocity}"
