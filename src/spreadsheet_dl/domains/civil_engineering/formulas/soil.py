...
Implements:
    REQ-C004-013: Soil formulas (BEARING_CAPACITY, SETTLEMENT, SOIL_PRESSURE)
"""
...
class BearingCapacityFormula(BaseFormula):
    ...
    Implements:
        REQ-C004-013: BEARING_CAPACITY formula
    ...
    def build(self, *args: Any, **kwargs: Any) -> str:
        ...
        return f"{c}*{Nc}+{gamma}*{D}*{Nq}+0.5*{gamma}*{B}*{Ngamma}"
...
class SettlementFormula(BaseFormula):
    ...
    Implements:
        REQ-C004-014: SETTLEMENT formula
...
class SoilPressureFormula(BaseFormula):
    ...
    Implements:
        REQ-C004-015: SOIL_PRESSURE formula
