...
class EmailChannel:
    ...
    def _format_subject(self, notification: Notification) -> str:
        ...
        return f"{priority_prefix[notification.priority]}Finance Tracker: {notification.title}"
    ...
    def _format_text_body(self, notification: Notification) -> str:
        ...
        lines.extend([
            "",
            "---",
            f"Sent by Finance Tracker at {notification.created_at.strftime('%Y-%m-%d %H:%M')}",
        ])
    ...
    def _format_html_body(self, notification: Notification) -> str:
        ...
        <body>
            <div class="container">
                ...
                <div class="footer">
                    <p>Sent by Finance Tracker at {notification.created_at.strftime('%Y-%m-%d %H:%M')}</p>
                </div>
            </div>
        </body>
        </html>
