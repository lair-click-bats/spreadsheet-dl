...
class FinanceTrackerError(Exception):
    ...
    doc_url_base: str = "https://finance-tracker.readthedocs.io/errors"
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(
            ...
            suggestion="Install the plugin with: pip install finance-tracker-plugin-{name}",
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(
            ...
            suggestion=f"Update plugin: pip install --upgrade finance-tracker-plugin-{plugin_name}",
