...
def test_dpmo_build() -> None:
    ...
    assert result == "(25/(1000*5))*1000000"
...
def test_dpmo_with_cells() -> None:
    ...
    assert result == "(A1/(B1*C1))*1000000"
