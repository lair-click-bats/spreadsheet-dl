...
def test_abc_analysis_build() -> None:
    ...
    assert result == "(50000/200000)*100"
...
def test_abc_analysis_class_a() -> None:
    ...
    assert result == "(150000/200000)*100"
