...
def test_thermal_expansion_formula_metadata() -> None:
    """Test ThermalExpansionFormula metadata."""
...
def test_thermal_expansion_formula_build() -> None:
    """Test ThermalExpansionFormula formula building."""
    formula = ThermalExpansionFormula()
...
def test_thermal_expansion_formula_validation() -> None:
    """Test ThermalExpansionFormula argument validation."""
    formula = ThermalExpansionFormula()
...
def test_original_formulas_still_work() -> None:
    ...
    expansion = ThermalExpansionFormula()
