...
class TestPIIDetector:
    ...
    def test_remove_pii(self, detector):
        """Test PII removal."""
    ...
    def test_tokenize_description(self, detector):
...
class TestDataAnonymizer:
    ...
    def test_anonymize_transaction(self, anonymizer):
    ...
    def test_anonymize_transaction_buckets(self, anonymizer):
    ...
    def test_anonymize_transaction_temporal_features(self, anonymizer):
    ...
    def test_anonymize_dataset(self, anonymizer):
    ...
    def test_dataset_statistics(self, anonymizer):
...
class TestTrainingDataExporter:
    ...
    def test_export_json(self, exporter, sample_dataset, tmp_path):
        """Test JSON export."""
    ...
    def test_export_csv(self, exporter, sample_dataset, tmp_path):
        """Test CSV export."""
    ...
    def test_stream_records(self, exporter, sample_dataset):
