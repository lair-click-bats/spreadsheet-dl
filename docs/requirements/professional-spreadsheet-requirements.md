...
| Phase 5: Advanced Features | FR-FORMAT-*, FR-COND-*, FR-VALID-*, FR-CHART-* | 36 |
| Phase 6: Polish & Docs | DOC-PROF-*, FR-PROF-*, FR-PRINT-* | 19 |
...
*End of Professional Spreadsheet Requirements Specification*
