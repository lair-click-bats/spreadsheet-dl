...
| Security & Privacy     | Yes     | Complete - FR-SEC-001, NFR-SEC-_, DR-PRIV-_        |
...
| Integrations           | Yes     | Complete - IR-NC-_, IR-MCP-_, IR-CAL-_, IR-NOTIF-_ |
...
- **G-01 to G-20**: All mapped to FR-_ or NFR-_ requirements
...
- FR-FMT-010 AC1 "Auto-detect from LANG/LC\_\*": Specify fallback behavior
