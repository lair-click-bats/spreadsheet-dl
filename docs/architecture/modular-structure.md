...
As of v4.0.0, SpreadsheetDL has begun transitioning to a more modular package structure to improve maintainability and code organization. The large monolithic files have been split into focused packages.
...
- ⏳ Phase out monolithic files (post-v4.0.0)
