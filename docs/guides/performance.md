...
This guide provides benchmarks, optimization techniques, and best practices for achieving optimal performance with SpreadsheetDL v4.0.0.
...
SpreadsheetDL v4.0.0 is optimized for both small quick-generation tasks and large-scale spreadsheet processing. Performance targets:
