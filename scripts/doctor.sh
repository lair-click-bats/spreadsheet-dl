...
check_tools "LaTeX Tools" LATEX_TOOLS
check_tools "Perl Tools" PERL_TOOLS
check_tools "HDL Tools" HDL_TOOLS
...
configs=(
    ...
    ".chktexrc:ChkTeX config"
    ".latexindent.yaml:latexindent config"
    ".perlcriticrc:Perl::Critic config"
    ".perltidyrc:perltidy config"
    "tclint.toml:TCL lint config"
    ".vsg.yaml:VSG config"
)
