...
def example_column_charts() -> None:
    ...
    print(f"   Title: {chart.title.text if chart.title else 'N/A'}")
    print(f"   Series: {len(chart.series)}")
    print(f"   Position: {chart.position.cell}")
...
def example_pie_charts() -> None:
    ...
    print(f"   Chart type: {chart.chart_type.name}")
    print(f"   Legend visible: {chart.legend.visible}")
...
def example_chart_styling() -> None:
    ...
    print(f"   Title font size: {chart.title.font_size if chart.title else 'N/A'}")
    print(f"   Title color: {chart.title.color if chart.title else 'N/A'}")
    print(
...
def example_chart_positioning() -> None:
    ...
    print(f"   Anchor cell: {chart.position.cell}")
    print(f"   Size: {chart.size.width}x{chart.size.height}px")
    ...
    print(f"   Anchor cell: {chart.position.cell}")
    print(f"   Offset: X={chart.position.offset_x}px, Y={chart.position.offset_y}px")
    ...
    print(f"   Move with cells: {chart.position.move_with_cells}")
    print(f"   Size with cells: {chart.position.size_with_cells}")
